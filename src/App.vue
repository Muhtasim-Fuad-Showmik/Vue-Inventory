...
<template>
    <main
        class="h-[90vh] my-0 mx-auto bg-white rounded shadow-[0_0_130px_-50px_rgba(0,108,233,1)] overflow-hidden"
    >
        <div class="flex flex-row min-h-[90vh]">
            <div class="w-80 min-h-[90vh]">
                <header class="flex flex-col h-full bg-white">
                    <div class="bg-brandeis-blue">
                        <a
                            href="/"
                            class="inline-block w-full p-5 bg-white rounded-bl-lg"
                        >
                            <div class="flex">
                                <img
            ...
            <div class="w-full min-h-[90vh]">
                <div
                    class="h-full p-4 border-b-8 border-solid border-brandeis-blue"
                >
                    <RouterView />
                </div>
            </div>
