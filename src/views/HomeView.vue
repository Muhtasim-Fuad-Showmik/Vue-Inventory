  ...
  <main class="w-full h-full max-h-full overflow-hidden">
    ...
    <div class="h-full max-h-[calc(100%-60px)] overflow-auto">
      ...
      <div class="flex justify-between min-w-full p-2 mb-5">
        <select
          class="p-2 font-normal bg-white border rounded-md shadow cursor-pointer font-Sen"
      ...
      <div class="grid md:grid-cols-2 grid-cols-1 gap-4 min-w-full p-2 mb-5">
        <ContentCard customStyle="w-full" title="Inventory Value per Outlet">
          <div className="h-5 w-14 text-sm mt-2">
            <span className="w-full h-full rounded-md p-1 bg-neutral-200 text-neutral-700"
              >100%</span
            >
          </div>
        ...
        <ContentCard customStyle="w-full" title="Monthly Value per Outlet">
          <div className="h-5 w-14 text-sm mt-2">
            <span className="w-full h-full rounded-md p-1 bg-neutral-200 text-neutral-700"
              >100%</span
            >
